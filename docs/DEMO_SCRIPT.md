...
| 0:38–0:50 | In ChatGPT, ask: “Read this application, audit it, and do not edit or submit anything.” | I ask the agent to inspect, not edit: read this application, audit it, and tell me what is missing. It cannot invent facts, apply patches, authorize, or submit. |
